  ...
  <div class="right-product right-off">
     <div class="container-fluid">
				<div class="info-center">
                    ...
                    <form action="?r=message/add" method="post">
                    <center>
                      <table border="1">
                        <tr>
                          <td>公司简介</td>
                          <td><textarea name="synopsis" id="" cols="30" rows="10"><?= $data['synopsis']?></textarea></td>
                        </tr>
                        <tr>
                          <td>企业文化</td>
                          <td><input type="text"  name ="culture" value="<?= $data['culture'] ?>" /></td>
                        </tr>
                        <tr>
                          <td>核心价值观</td>
                          <td><input type="text" name="hexinjiazhiguan" value="<?= $data['hexinjiazhiguan'] ?>" /></td>
                        </tr>
                        <tr>
                          <td>经营理念</td>
                          <td><input type="text" name="linian" value="<?= $data['linian'] ?>" /></td>
                        </tr>
                        <tr>
                          <td>户名</td>
                          <td><input type="text" name="huming" value="<?= $data['huming'] ?>" /></td>
                        </tr>
                        <tr>
                          <td>开户行</td>
                          <td><input type="text" name="kaihuhang" value="<?= $data['kaihuhang'] ?>" /></td>
                        </tr>
                        <tr>
                          <td>账号</td>
                        ...
                        <tr>
                          <td>行号</td>
                          <td><input type="text" name="hanghao" value="<?= $data['hanghao'] ?>" /></td>
                        </tr>
                        <tr>
                          <td>备注</td>
                          <td><input type="text" name="beizhu" value="<?= $data['beizhu'] ?>" /></td>
                        </tr>
                        <tr>
