     ...
     <div class="container-fluid">
				<div class="info-center">
					...
					<div class="table-margin">
                      ...
                      <thead>
                         <tr>
                           <td class="w70">公司简介</td>
                           <td class="w15">企业文化</td>
                           <td class="w15">核心价值观</td>
                           <td class="w15">经营理念</td>
                           <td class="w15">户名</td>
                           <td class="w15">开户行</td>
                           <td class="w15">账号</td>
                           <td class="w15">行号</td>
                         ...
                         <tr>
                          <td><?= $data['synopsis']?></td>
                          <td><?= $data['culture'] ?></td>
                          <td><?= $data['hexinjiazhiguan'] ?></td>
                          <td><?= $data['linian'] ?></td>
                          <td><?= $data['huming'] ?></td>
                          <td><?= $data['kaihuhang'] ?></td>
                          <td><?= $data['account'] ?></td>
                          <td><?= $data['hanghao'] ?></td>
                          <td><?= $data['beizhu'] ?></td>
                          <td><a href="?r=message/updates">修改</a></td>
                         </tr>
                         </tbody>
                      </table>
                    </div>
