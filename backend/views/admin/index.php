    ...
    <div class="subNavBox">
      ...
      <div class="sBox">
        ...
        <ul class="navContent" style="display:none">
          ...
          <li>
            <div class="showtitle" style="width:100px;"><img src="img/leftimg.png" />添加新闻</div>
            <a href="?r=message/index"><span class="sublist-icon glyphicon glyphicon-user"></span><span class="sub-title">公司管理</span></a></li>
          <li>
            <div class="showtitle" style="width:100px;"><img src="img/leftimg.png" />添加新闻</div>
            <a href="#"><span class="sublist-icon glyphicon glyphicon-user"></span><span class="sub-title">添加新闻</span></a></li>
          <li>
       ...
       <!---title----->
            <div class="info-title">
              <div class="pull-left">
                ...
                <p>欢迎登录管理系统！ <a href="http://www.aspku.com/" target="_blank">源码之家</a></p>
              </div>
